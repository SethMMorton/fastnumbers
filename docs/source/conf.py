# -*- coding: utf-8 -*-
#
# fastnumbers documentation build configuration file, created by
...
htmlhelp_basename = 'fastnumbersdoc'
...
latex_documents = [
  ('index', 'fastnumbers.tex', u'fastnumbers Documentation',
...
man_pages = [
    ('index', 'fastnumbers', u'fastnumbers Documentation',
     [u'Seth M. Morton'], 1)
]
...
texinfo_documents = [
  ('index', 'fastnumbers', u'fastnumbers Documentation',
   u'Seth M. Morton', 'fastnumbers', 'One line description of project.',
   'Miscellaneous'),
]
