...
class FloatSubclass(__builtin__.float):
    pass

class OtherFloatSubclass(__builtin__.float):
    pass
...
class GeneralFloatCases(unittest.TestCase):
    ...
    def test_floatconversion(self):
        ...
        class Foo2(__builtin__.float):
            def __float__(self):
                return 42.

        class Foo3(__builtin__.float):
            def __new__(cls, value=0.):
                return __builtin__.float.__new__(cls, 2*value)

            def __float__(self):
                return self

        class Foo4(__builtin__.float):
            def __float__(self):
                return 42
