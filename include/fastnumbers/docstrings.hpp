...
PyDoc_STRVAR(
    ...
    "    *False*.\n"
    "map : bool, optional\n"
    "    If *True*, instead of accepting a single value to convert this function\n"
    "    accepts an iterable of values to convert and returns a *list* of the results.\n"
    ...
    "    If *map* is *True*, then the output will be a *list* of these things.\n"
    "\n"
    "Raises\n"
    "------\n"
    "TypeError\n"
...
PyDoc_STRVAR(
    ...
    "    7\n"
    "    >>> try_forceint(['56', '56.07'], map=True)\n"
    "    [56, 56]\n"
    "\n"
);
