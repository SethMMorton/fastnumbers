...
PyDoc_STRVAR(
    map_try_real__doc__,
    "map_try_real(x, *, inf=fastnumbers.ALLOWED, nan=fastnumbers.ALLOWED, "
    "on_fail=fastnumbers.INPUT, on_type_error=fastnumbers.RAISE, "
    "coerce=True, allow_underscores=False)\n"
    "Quickly convert an iterable's contents to *int* or *float* depending on value.\n"
    "\n"
    "This is functionally identical to ``[try_real(x) for x in myiterable]``\n"
    "but is twice as fast.\n"
    "\n"
    "All arguments are identical and behave identically to :func:`try_real`.\n"
    "\n"
    "Returns\n"
    "-------\n"
    "result : list\n"
    "    The converted elements, in a list.\n"
    "\n"
    "See Also\n"
    "--------\n"
    "try_real\n"
...
PyDoc_STRVAR(
    ...
    "map_try_float(x, *, inf=fastnumbers.ALLOWED, nan=fastnumbers.ALLOWED, "
    "on_fail=fastnumbers.INPUT, on_type_error=fastnumbers.RAISE, "
    "allow_underscores=False)\n"
    "Quickly convert an iterable's contents to *float*.\n"
    "\n"
    "This is functionally identical to ``[try_float(x) for x in myiterable]``\n"
    "but is twice as fast.\n"
    "\n"
    "All arguments are identical and behave identically to :func:`try_float`.\n"
    "\n"
    "Returns\n"
    "-------\n"
    "result : list\n"
...
PyDoc_STRVAR(
    map_try_int__doc__,
    "map_try_int(x, *, on_fail=fastnumbers.INPUT, on_type_error=fastnumbers.RAISE, "
    "base=10, allow_underscores=False)\n"
    "Quickly convert an iterable's contents to *int*.\n"
    "\n"
    "This is functionally identical to ``[try_int(x) for x in myiterable]``\n"
    "but is twice as fast.\n"
    "\n"
    "All arguments are identical and behave identically to :func:`try_int`.\n"
    "\n"
    "Returns\n"
    "-------\n"
    "result : list\n"
...
PyDoc_STRVAR(
    ...
    "map_try_forceint(x, *, on_fail=fastnumbers.INPUT, on_type_error=fastnumbers.RAISE, "
    "allow_underscores=False)\n"
    "Quickly convert an iterable's contents to *int*, truncating if a *float*.\n"
    "\n"
    "This is functionally identical to ``[try_forceint(x) for x in myiterable]``\n"
    "but is twice as fast.\n"
    "\n"
    "All arguments are identical and behave identically to :func:`try_forceint`.\n"
    "\n"
    "Returns\n"
    "-------\n"
    "result : list\n"
