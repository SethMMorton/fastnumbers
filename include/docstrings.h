...
"fast_real(x, default=None, raise_on_invalid=False, key=None, nan=None, inf=None)\n"
...
"    If the input is of type *float*, but can be converted to an *int*\n"
"    without loss of precsion, coerce to an *int* rather than returning\n"
"    the *float* as-is.\n"
"\n"
"Returns\n"
"-------\n"
