...
"\n"
"Single, whitespace-padded non-ASCII Unicode characters may be given and\n"
"will be converted to the same value as given by the `numeric` function from\n"
"the `unicodedata` standard library module.\n"
"\n"
"Parameters\n"
"----------\n"
...
"\n"
"Single, whitespace-padded non-ASCII Unicode characters may be given and\n"
"will be converted to the same value as given by the `digit` function from\n"
"the `unicodedata` standard library module.\n"
"\n"
"Parameters\n"
"----------\n"
...
"\n"
"Single, whitespace-padded non-ASCII Unicode characters may be given and\n"
"will be converted to the same value as given by the `numeric`\n"
"function from the `unicodedata` standard library module\n"
"(using the same criteria as described in the above paragraph).\n"
"\n"
"Parameters\n"
"----------\n"
"input : {str, float, int, long}\n"
...
"This function returns *True* for any input that\n"
"`fast_real` can convert. By default 'inf' and 'nan' will return\n"
"*False*.\n"
"\n"
"Single, whitespace-padded non-ASCII Unicode characters may be given and\n"
"will return `True` for values that would not raise a `ValueError` for the\n"
"`numeric` function from the `unicodedata` standard library module.\n"
"\n"
"Parameters\n"
"----------\n"
"input :\n"
...
"Single, whitespace-padded non-ASCII Unicode characters may be given and\n"
"will return `True` for values that would not raise a `ValueError` for the\n"
"`digit` function from the `unicodedata` standard library module.\n"
"\n"
